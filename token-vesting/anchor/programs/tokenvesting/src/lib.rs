...
declare_id!("AKoHyBkr73UYNK1qCe3qu4HqBzJBLd1W9KR2Kmpkmtzz");
...
pub mod tokenvesting {
  ...
  pub fn create_employee_vesting(ctx: Context<CreateEmployeeAccount>, start_time: i64, end_time: i64, total_amount: i64, cliff_time: i64) -> Result<()> {
  ...
  pub fn claim_tokens(ctx: Context<CliamTokens>, _company_name: String) -> Result<()> {
    ...
    let total_vesting_time = employee_account.end_time.saturating_sub(employee_account.total_amount);
...
#[error_code]
pub enum ErrorCode {
  #[msg("cliaming is not available yet")]
